 ...
 */
class PodcastersRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return Podcasters[] Returns an array of Podcasters objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Podcasters
    {
        return $this->createQueryBuilder('p')
            ->andWhere('p.exampleField = :val')
            ->setParameter('val', $value)
