...
class EventController extends AbstractController
{
     ...
     * @throws Exception
     */
    public function newJson(Request $request, EventRepository $eventRepository,UserRepository $userRepository)
    {
        $event = new Event();
     ...
     */
    public function getAllJson(Request $request, EventRepository $eventRepository,UserRepository $userRepository)
    {
        $events = $eventRepository->findAll();
     ...
     * @throws ExceptionInterface
     */
    public function showJson(Request $request, Event $event,EventRepository $eventRepository, ReviewRepository $reviewRepository,UserRepository $userRepository,ValidatorInterface $validator): Response
    {
        $user = $userRepository->find(1);
     ...
     */
    public function UserParticipateJson(MailerInterface $mailer,Request $request,EventRepository $eventRepository,ReviewRepository $reviewRepository, ValidatorInterface $validator, Event $event,UserRepository $userRepository)
    {
        $user = $userRepository->find(2);
        $participants = $event->getParticipants();
